...
$(ACPPOBJS) : $(OBJDIR)/%.o : %.cpp $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
	$(CPPC) -c $(CPPFLAGS) $(AOPT) -I. $(IINCDIR) $< -o $@
else
	@echo "$(COLOR) Compiling $(<) $(COLOR_CLEAR)"
	@$(CPPC) -c $(CPPFLAGS) $(AOPT) -I. $(IINCDIR) $< -o $@
endif

$(TCPPOBJS) : $(OBJDIR)/%.o : %.cpp $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(ACOBJS) : $(OBJDIR)/%.o : %.c $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(TCOBJS) : $(OBJDIR)/%.o : %.c $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(ASMOBJS) : $(OBJDIR)/%.o : %.s $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(ASMXOBJS) : $(OBJDIR)/%.o : %.S $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
ifeq ($(USE_VERBOSE_COMPILE),yes)
	...
	@echo "$(COLOR) Linking $@ $(COLOR_CLEAR)"
	@$(LD) $(OBJS) $(LDFLAGS) $(LIBS) -o $@
endif
...
ifeq ($(USE_VERBOSE_COMPILE),yes)
	...
	@echo "$(COLOR) Creating $@ $(COLOR_CLEAR)"
	@$(HEX) $< $@
endif
